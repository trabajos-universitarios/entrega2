# Generated by Django 4.1.8 on 2023-04-17 07:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idprod', models.ForeignKey(db_column='idprod', on_delete=django.db.models.deletion.DO_NOTHING, to='BA.producto')),
                ('nrofac', models.ForeignKey(blank=True, db_column='nrofac', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='BA.factura')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nrofac', models.ForeignKey(db_column='nrofac', on_delete=django.db.models.deletion.DO_NOTHING, to='BA.factura')),
                ('ruttec', models.ForeignKey(db_column='ruttec', on_delete=django.db.models.deletion.DO_NOTHING, to='BA.perfilusuario')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='factura',
            name='idprod',
            field=models.ForeignKey(db_column='idprod', on_delete=django.db.models.deletion.DO_NOTHING, to='BA.producto'),
        ),
        migrations.AddField(
            model_name='factura',
            name='rutcli',
            field=models.ForeignKey(db_column='rutcli', on_delete=django.db.models.deletion.DO_NOTHING, to='BA.perfilusuario'),
        ),
    ]
